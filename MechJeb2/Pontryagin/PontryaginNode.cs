...
namespace MuMech {
    public class PontryaginNode : PontryaginBase {
        public PontryaginNode(MechJebCore core, double mu, Vector3d r0, Vector3d v0, Vector3d pv0, Vector3d pr0, double dTguess) : base(core, mu, r0, v0, pv0, pr0)
        {
            tc1 = dTguess / 2.0;
            tgo = dTguess;
            tc2 = 0;
        ...
        public override void Bootstrap(double t0)
        {
            ...
            arcs.Add(new Arc(this, done: true));
